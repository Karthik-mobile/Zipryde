...
public class ScheduledZipRydeFragment extends Fragment {
    ...
    public void getBookingByBookingStatus(SingleInstantParameters loginCredentials) {
        if (Utils.connectivity(getActivity())) {
            ...
            Call<LinkedList<ListOfBooking>> call = apiService.getBookingByBookingStatusAndUserId(Utils.verifyLogInUserMobileInstantResponse.getAccessToken(),loginCredentials);
