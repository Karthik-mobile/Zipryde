...
public class FetchAddressIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        mReceiver = intent.getParcelableExtra(Utils.RECEIVER);
...
//            errorMessage = getString(R.string.no_location_data_provided);
            ...
            deliverResultToReceiver(Utils.FAILURE_RESULT, errorMessage,addressSend);
            return;
        }
...
//            Log.i(TAG, getString(R.string.address_found));
            ...
            deliverResultToReceiver(Utils.SUCCESS_RESULT,
                    "Sucess",address);
        }
    }
    ...
    private void deliverResultToReceiver(int resultCode, String message,Address address) {
        ...
        bundle.putParcelable(Utils.RESULT_DATA_KEY, address);
        bundle.putString(Utils.RESULT_MESSAGE, message);
